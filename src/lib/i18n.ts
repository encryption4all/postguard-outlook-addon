...
const en: Bundle = {
  ...
  errorRetry: "Retry",
  dialogClose: "Close",
  decryptedOpenedInWindow: "Your decrypted message opened in a separate window.",
  decryptedReopen: "Show decrypted message",
  decryptedAttachmentsHeading: "Attachments",
  removeRecipient: "Remove",
  loading: "Loading",
  metaFrom: "From",
  metaFromVerified: "Verified sender",
  senderUnverified: "unverified",
  senderMismatchWarning: "Warning: the message header names a different sender:",
  metaDate: "Date",
...
const nl: Bundle = {
  ...
  dialogClose: "Sluiten",
  decryptedOpenedInWindow: "Je ontsleutelde bericht is in een apart venster geopend.",
  decryptedReopen: "Toon ontsleuteld bericht",
  decryptedAttachmentsHeading: "Bijlagen",
  removeRecipient: "Verwijderen",
  loading: "Bezig met laden",
  metaFrom: "Van",
  metaFromVerified: "Geverifieerde afzender",
  senderUnverified: "niet geverifieerd",
  senderMismatchWarning: "Waarschuwing: de berichtkop noemt een andere afzender:",
  metaDate: "Datum",
